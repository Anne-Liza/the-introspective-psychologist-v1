...
DEFAULT_LANDING_SECTIONS = [
    {
        "key": "home.hero",
        "eyebrow": "Generated portfolio",
        "title": "Build a focused digital presence.",
        "body": "Use this homepage to introduce the work, services, story, or mission behind this portfolio. Replace this starter copy from the admin dashboard.",
    ...
    },
    {
        "key": "home.about",
        "eyebrow": "About",
        "title": "A clear space for your story.",
        "body": "Share the background, experience, values, and proof points that help visitors understand who this portfolio represents.",
    ...
    },
    {
        ...
        "body": "Highlight the strongest work here. The generated app already includes sample projects that can be replaced with real client content.",
    ...
    },
    {
        ...
        "body": "Invite visitors to reach out, request a service, book a consultation, or learn more about the work.",
        "cta_label": "Contact",
        "cta_url": "/contact",
        "image_url": None,
        "sort_order": 4,
    ...
    },
    {
        ...
        "body": "Use this section to add a fuller biography, company story, or client profile. Edit or replace this starter content before launch.",
        "cta_label": None,
        "cta_url": None,
        "image_url": None,
        "sort_order": 1,
